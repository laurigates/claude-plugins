...
> **Use underscores in tag names, not hyphens.** Taskwarrior parses `-`
...
> silently dropped. Quoting (`'+blocked-on-merge'`) does not help.
> Use `+blocked_on_merge` or `+blockedOnMerge`.
