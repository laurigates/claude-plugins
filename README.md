...
```bash
claude plugin install lgates-claude-plugins/<plugin-name>
```

For example:
```bash
claude plugin install lgates-claude-plugins/git-plugin
claude plugin install lgates-claude-plugins/python-plugin
```
