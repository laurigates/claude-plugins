...
| A loop no text bounds (`while (true)` with no stated count, a counter it moves back, a list it grows), a hand-built iterator, an implicitly called `toString`/`then` | HIGH, one over the limit | **`ask`** |
